    ...
    <main className="min-h-screen bg-brand-white">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-16 grid grid-cols-1 md:grid-cols-2 gap-16">
        ...
        <div>
          ...
          >
            Whether you're interested in a custom piece, have a question about
            our products, or simply want to talk about Bauhaus design — we'd
          ...
          <div className="space-y-6">
            {[
              ...
              <div
                ...
                style={{ borderColor: "oklch(0.52 0.22 27)" }}
              >
                <p
        ...
        <div>
          {submitted ? (
            ...
            <form
              ...
              className="space-y-0 border-2 border-brand-black"
            >
              {[
                {
                  id: "name",
