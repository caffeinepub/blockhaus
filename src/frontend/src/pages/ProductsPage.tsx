          ...
          <div className="flex items-center gap-0 overflow-x-auto">
            ...
            {categories.map((cat) => (
              <button
                ...
                style={{
                  backgroundColor:
                    activeCategory === cat ? "oklch(0.10 0 0)" : "transparent",
                  color:
                    activeCategory === cat
                      ? "oklch(0.99 0 0)"
                      : "oklch(0.45 0 0)",
            ...
            {filteredProducts.map((product, index) => {
              ...
              return (
                <button
                  type="button"
                  key={product.id}
                  className={`group cursor-pointer bg-brand-white border-brand-black transition-all duration-300 text-left w-full ${
