    ...
    <main className="min-h-screen bg-brand-white">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              ...
              <span style={{ color: "oklch(0.52 0.22 27)" }}>ATELIER</span>
            </h1>
          </div>
          <div>
            <p
            ...
            >
              We are a luxury home goods brand rooted in the principles of the
              Bauhaus movement — the radical idea that art, craft, and industry
          ...
          {[
            {
              ...
              body: "Every Haus Atelier piece is hand-tufted by skilled artisans using traditional techniques passed down through generations. We use only premium wool and natural materials, ensuring each piece is built to last a lifetime.",
            },
            {
              title: "THE FORM",
      ...
      <div className="w-full relative" style={{ height: "500px" }}>
        <img
          ...
          alt="Haus Atelier artisan at work"
        ...
        >
          ...
          >
            "ART AND CRAFT ARE ONE. FORM FOLLOWS FUNCTION. BEAUTY IS NEVER
            ACCIDENTAL."
          </blockquote>
        </div>
      </div>
