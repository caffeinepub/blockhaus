    ...
    <section className="w-full grid grid-cols-1 md:grid-cols-2 min-h-[600px]">
      ...
      >
        ...
        <div className="flex mb-8 h-1">
          ...
          <div
            className="w-6"
            style={{ backgroundColor: "oklch(0.68 0.18 52)" }}
          />
        </div>
        ...
        >
          Blockhaus was born from a deep reverence for the Bauhaus movement —
          the belief that art and craft are inseparable, that beauty must serve
          function, and that geometry is the universal language of design.
        </p>
        <p
          className="font-body text-sm leading-relaxed mb-4 max-w-md"
          style={{ color: "oklch(0.30 0 0)" }}
        >
          Every piece in our collection is hand-tufted by skilled artisans who
          share our obsession with precision and texture. We work with premium
          wool and natural materials, creating objects that are as tactile as
          they are visual.
        </p>
        <p
          ...
          style={{ color: "oklch(0.30 0 0)" }}
        >
          Our palette — red, blue, orange, white — is not arbitrary. These are
          the colors of the Bauhaus masters, chosen for their psychological
          power and visual clarity. In every rug, mirror, and pillow, we carry
          that legacy forward.
        </p>
