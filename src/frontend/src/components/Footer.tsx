...
const hoverOn = (e: React.MouseEvent<HTMLElement>, color: string) => {
...
export default function Footer() {
  ...
  const appId = encodeURIComponent(
    typeof window !== "undefined" ? window.location.hostname : "haus-atelier",
  );
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="md:col-span-1">
          ...
          <p
            className="font-body text-[10px] tracking-[0.18em] uppercase mb-3"
          ...
          >
            Bauhaus-inspired luxury home goods. Handcrafted tufted textiles
            where geometry meets warmth.
          </p>
          {/* Social Icons */}
          <div className="flex gap-4">
            <a
              ...
              style={{ color: "oklch(0.65 0 0)" }}
              onMouseEnter={(e) => hoverOn(e, "oklch(0.52 0.22 27)")}
              onMouseLeave={(e) => hoverOn(e, "oklch(0.65 0 0)")}
            >
              <SiInstagram size={18} />
            </a>
            <a
            ...
            {navLinks.map((link) => (
              <li key={link.href}>
                <Link
                  ...
                  style={{ color: "oklch(0.65 0 0)" }}
                  onMouseEnter={(e) => hoverOn(e, "oklch(0.99 0 0)")}
                  onMouseLeave={(e) => hoverOn(e, "oklch(0.65 0 0)")}
                >
                  {link.label}
                </Link>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li>
              <a
                href="mailto:hello@hausatelier.com"
                className="font-body text-xs transition-colors"
                style={{ color: "oklch(0.65 0 0)" }}
                onMouseEnter={(e) => hoverOn(e, "oklch(0.99 0 0)")}
                onMouseLeave={(e) => hoverOn(e, "oklch(0.65 0 0)")}
              >
                hello@hausatelier.com
              </a>
            </li>
            <li>
              <p
      ...
      >
        <p className="font-body text-xs" style={{ color: "oklch(0.45 0 0)" }}>
          © {year} Haus Atelier. All rights reserved.
        </p>
        <p
