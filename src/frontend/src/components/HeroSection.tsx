  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to right, oklch(0.10 0 0 / 0.72) 0%, oklch(0.10 0 0 / 0.25) 60%, transparent 100%)",
        }}
      />
      ...
      {/* Content */}
      <div
        className="relative z-10 flex flex-col justify-end h-full px-10 md:px-20 pb-20 pt-32"
        style={{ minHeight: "92vh" }}
      >
        <div className="max-w-2xl">
          ...
          >
            Haus Atelier — Sculpted in Softness
          </p>
          ...
          >
            Handcrafted tufted textiles where Bauhaus geometry meets the warmth
            of home.
          </p>
